        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-2">
            <Link href="/" className="flex items-center gap-2 mb-4 group">
              <Image src="/logo.png" alt="biztrack" width={100} height={100} />
            </Link>

            <Typography variant="body" className="text-secondary mb-6 max-w-sm">
              Empowering Nigerian SMEs with modern, accessible business
              management tools. Manage sales, inventory, and customers from
